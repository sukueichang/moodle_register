...
require_login();
// Self-service cancel: any learner who can view the plugin and owns the enrolment
// may cancel. Do not require local/tm_course:enrol (that gates new applications).
