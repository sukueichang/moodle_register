<?php
/**
 * Admin: Attendance Management (M3)
 * URL: /local/tm_course/admin/attendance.php?sessionid=N
 *
...
$PAGE->set_url(new moodle_url('/local/tm_course/admin/attendance.php'));
$PAGE->set_title(get_string('nav_attendance', 'local_tm_course'));
...
$back_url  = new moodle_url('/local/tm_course/admin/attendance.php', ['sessionid' => $sessionid]);
...
function att_url(string $act, int $sid, int $eid = 0): string {
    ...
    return (new moodle_url('/local/tm_course/admin/attendance.php', $p))->out();
}
...
<div class="tm-page-header">
    ...
    <h2><?php echo get_string('nav_attendance', 'local_tm_course'); ?>
